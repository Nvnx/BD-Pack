    ...
    return [
      {
        title: 'fixed',
        type: 'fixed',
        items: ['Removed keybinds due to them causing a startup error and not being a used feature.', 'Fixed auto update on powercord resulting in nothing happening but the notif repeating itself.', 'Fix auto update on powercord attempt 2.']
      }
    ];
  }
  initialize() {
